...
| Клавиша | Действие |
|---------|----------|
| **F6** | Переключение между панелями (список чатов → сообщения → поле ввода) |
| **Shift+F6** | Переключение в обратном порядке |
| **Ctrl+Tab** | То же, что F6 |
| **Escape** | Вернуться в список чатов |
| **Стрелки** | Навигация по списку чатов и по сообщениям в открытом чате |
| **Tab** / **Shift+Tab** | В панели сообщений: переход по ссылкам и вложениям в выбранном сообщении |
| **Enter** | В панели сообщений: открыть вложение, ссылку или воспроизвести медиа |
...
5. В списке чатов **стрелки вверх/вниз** — каждый чат озвучивается **один раз** (без дубля).
6. В открытом чате **стрелки** — сообщения с именем отправителя и кратким текстом/типом вложения.
7. **Tab** в сообщении со ссылкой — «Ссылка N из M» и описание.
8. **Enter** — открытие вложения или воспроизведение медиа.
