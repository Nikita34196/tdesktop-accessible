...
| Клавиша | Действие |
|---------|----------|
| **F6** | Панели: чаты → сообщения → клавиатура бота (если есть) → ввод |
| **Shift+F6** | Панели в обратном порядке |
| **Ctrl+Tab** | То же, что F6 |
| **Escape** | Из клавиатуры бота — в поле ввода; иначе — в список чатов |
| **Home** / **End** | В списке чатов — первый / последний чат |
| **Стрелки** | Чаты и сообщения (краткая озвучка, без повтора) |
| **Tab** / **Shift+Tab** | В сообщении — ссылки/вложения; на клавиатуре бота — кнопки |
| **Enter** | Открыть файл, ссылку или медиа в выбранном сообщении |
| **Ctrl+Shift+O** | То же, что Enter (открыть вложение в фокусе) |
| **Ctrl+Shift+B** | Фокус на клавиатуру бота |
| **Ctrl+Shift+R** | Голосовое сообщение |
| **Ctrl+Shift+T** | Тест озвучки NVDA |
| **Ctrl+Shift+F6** | Дамп виджетов (отладка) |
...
8. Откройте чат с ботом и клавиатурой — **Ctrl+Shift+B**, стрелки, **Enter**.
9. Попросите собеседника печатать — должна озвучиться строка «Статус чата: …».
