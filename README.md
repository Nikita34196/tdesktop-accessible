...
| Клавиша | Действие |
|---------|----------|
| **F6** | Панели: чаты → сообщения → ввод → медиа → профиль → звонок → поиск |
...
| **Tab** / **Shift+Tab** | В сообщении: все ссылки, кнопки и вложения сверху вниз (Enter — открыть) |
...
| **Ctrl+Shift+P** | Открыть **фото и видео** чата |
| **Ctrl+Shift+G** | Фокус на **поиск чатов** |
| **Ctrl+Shift+E** | **Поиск в открытом чате** |
| **Ctrl+Shift+M** | **Закреплённые сообщения** |
| **Ctrl+Shift+Y** | Озвучить **статус** (онлайн, «печатает…») |
| **Ctrl+Shift+K** | **Стикеры и эмодзи** |
| **Ctrl+Shift+C** | **Групповой звонок** |
| **Ctrl+Shift+B** | Клавиатура бота |
| **Ctrl+Shift+O** | Открыть вложение в выбранном сообщении |
